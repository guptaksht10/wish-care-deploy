  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div className="grid gap-2">
        <div className="grid grid-cols-2 gap-3">
          <div className="grid gap-3">
            ...
            <Input id="name" type="text" placeholder="John" value={formData.name} onChange={handleChange} />
          </div>
          <div className="grid gap-3">
        ...
        <div className="grid gap-3">
          ...
          <Input id="username" type="text" placeholder="@JohnDoe" value={formData.username} onChange={handleChange} />
        </div>
      ...
      <div className="text-center text-sm flex items-center justify-center">
        ...
        <Link href="/auth/login" className="underline underline-offset-4" onClick={handleLogin}>
          {isredirect ? <div className="text-sm"><Loader text="Loading..." /></div> : "Login"}
        </Link>
      </div>
