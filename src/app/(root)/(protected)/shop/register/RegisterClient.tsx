  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-pink-100 via-purple-50 to-purple-100 px-6 py-20">
        ...
        >
          <div className="grid md:grid-cols-[1fr_auto_1fr] gap-10 items-stretch">
            {/* LEFT INFO */}
            <motion.div
            ...
            >
              ...
              <p className="text-lg text-gray-700 max-w-xl">
                WishCare helps sellers grow using trust, friends, and social
                proof — not ads.
              </p>
              ...
              <div className="rounded-xl bg-gradient-to-r from-pink-500 to-purple-600 p-5 text-white shadow-lg max-w-md">
                🚀 <strong>Early sellers</strong> get priority discovery &
                featured placement.
              </div>
            </motion.div>
            ...
            {/* FORM */}
            <div className="bg-white rounded-3xl border shadow-2xl p-10">
