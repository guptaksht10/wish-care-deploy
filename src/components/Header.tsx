...
export default function Header() {
    ...
    return (<header className="bg-white/80 backdrop-blur-md border-b sticky top-0 z-50 shadow-sm">
        <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between"> {/* Brand + Nav */}
                <div className="flex items-center space-x-8">
                    <Link href="/">
                        <h1 className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                            <div className="flex flex-row items-center"><Image src="/logofull_wishcare.png" alt="WishCare Logo"
                                    width={50}
                                    height={50}/>
                                WishCare</div>
                        </h1>
              ...
              <DropdownMenu>
                ...
                {/* Search + Icons */}
                <div className="flex items-center space-x-2"> {/* Search Box */}
                    ...
                    <Link href="/reels">
                        <Button variant="ghost" size="icon" className="relative hover:bg-purple-50"
                            ...
                            <Play className="h-5 w-5 text-purple-600"/> {/* New reels indicator */}
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" size="icon" className="hover:bg-purple-50"> {
                                session ?. user ?. image ? (<div className="w-8 h-8 rounded-md overflow-hidden">
                                    <Image src={
                                            session.user.image
                                        }
                                        alt="User Avatar"
                                ...
                                </div>) : (<User2 className="h-5 w-5 text-gray-700"/>)
                            } </Button>
                        </DropdownMenuTrigger>
                    ...
                    {/* Dark Mode Toggle */}
                    {
                    mounted && (<Button variant="ghost" size="icon"
                        onClick={
